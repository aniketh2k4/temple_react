                    ...
                    <div className="flex flex-col md:flex-row justify-center gap-6 items-center">
                        ...
                        <div className="text-center group cursor-pointer">
                            <div
                                ...
                                <svg className="w-full h-full text-maroon-900" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span
                                className="text-gold-400 text-xs uppercase tracking-widest font-bold group-hover:text-white transition-colors">Scan
                                to Donate</span>
                        </div>
                    </div>
                </div>
